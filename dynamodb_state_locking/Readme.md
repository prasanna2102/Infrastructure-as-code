There are devops enginners in xyz organization.Their task is to create ec2 instance using terraform.They are of team of 2 members.Suppose, dev1 is working on the project to ceate ec2
